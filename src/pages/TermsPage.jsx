...
export default function TermsPage() {
    return (
        <div className="policy-container">
            ...
            <p>This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://pathan-gadget.vercel.app/ ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').</p>
            <p>The Platform is owned by Pathan Gadgets, a company incorporated under the Companies Act, 1956 with its registered office at RZG-128 Nihal Vihar Nangloi New Delhi (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our').</p>
            ...
            <ul>
                ...
                <li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in New Delhi.</li>
